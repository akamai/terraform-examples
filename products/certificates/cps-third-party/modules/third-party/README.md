...
| <a name="input_config_section"></a> [config\_section](#input\_config\_section) | Section within the .edgerc file to use for authentication. Used for the ACME certificate DNS challenges. | `string` | n/a | yes |
